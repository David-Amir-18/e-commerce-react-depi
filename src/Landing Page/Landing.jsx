...
function Landing() {
  ...
  return (
    <div
      id="hero"
      className="video-background min-h-screen overflow-y-auto bg-black"
    >
      <video
        className="fixed top-0 w-full mx-auto h-full object-cover blur-[50px]"
        autoPlay
        muted
        loop
        playsInline
        ...
        <div className="py-25 max-md:px-0 md: px-8 grid grid-cols-1 xl:grid-cols-[2fr_1fr] w-full gap-10">
          ...
          <div className="flex items-center">
            <div className="card gap-5 h-full w-full justify-between">
              <h1 className="text-5xl lg:text-6xl xl:text-8xl text-amber-300 leading-[1.3]">
                Experience Flight Beyond First Class
              </h1>
              <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                <div className="card card-util1 p-6">
                  <div className="flex">
                    <p className="text-amber-400 mr-2">
                ...
                <div className="card card-util1 p-6">
                  ...
                  <p>
                    Discreet, secure, and seamless travel for elite clients.
                  </p>
                </div>
                <div className="card card-util1 p-6">
                  <div className="flex">
                ...
                <div className="card card-util1 p-6">
                  ...
                  <p>
                    Fine dining, private lounges, and bespoke in-flight comfort.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card card-util1 p-8">
            ...
            <p className="my-5 p1">
              Select your destinations and let us tailor every detail of your
              private flight.
            </p>
            ...
            <button className="mt-5 rounded-full transition-all border-2 text-amber-300 hover:bg-amber-300 hover:border-0 hover:text-black h-10">
              Search flights
            </button>
          </div>
        </div>
