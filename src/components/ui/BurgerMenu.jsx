function BurgerMenu({isMenuOpen, setIsMenuOpen}) {
      ...
      return (
            <button
                  onClick={toggleMenu}
                  className={`top-4 items-center rounded-full z-150 text-white transition-all duration-500 hover:bg-white hover:text-amber-500 border border-amber-300 backdrop-blur-lg ${isMenuOpen ? "bg-white text-amber-400 absolute right-6" : "right-8 fixed"}`}
